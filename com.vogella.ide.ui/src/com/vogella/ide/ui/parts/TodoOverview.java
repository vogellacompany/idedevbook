...
public class TodoOverview {
	...
	@PostConstruct
	public void createPartControl(Composite parent, ITodoService todoService, TagService<Todo> tagService) {
		myLabelInView = new Label(parent, SWT.BORDER);
		myLabelInView.setText("This is a sample E4 view");

		todoService.getTodos(System.out::println);

		List<Tag<Todo>> allTagsFromRoot = tagService.getAllTagsFromRoot();
		allTagsFromRoot.forEach(System.out::println);
	}
